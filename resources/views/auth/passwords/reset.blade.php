        ...
        <div class="account-box width-500">
            ...
            <form action="{{ route('password.update') }}" method="POST">
                ...
                <div class="textbox mb-3 password-toggle">
                    <input type="password" id="password" name="password" class="form-control" placeholder="Mật khẩu mới" value="{{ old('password') }}">
...
<script src="{{ asset(path: 'js/account.js') }}"></script>
